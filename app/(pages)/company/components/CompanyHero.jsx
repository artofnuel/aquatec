...
const CompanyHero = () => {
  ...
  return (
    <main className="mb-10 h-auto w-full xl:mt-20">
      <section className="mx-auto flex h-auto w-full max-w-4xl flex-col items-center justify-center gap-5 p-4 text-center">
        ...
        <p className="text-base xl:text-xl">
          At Aquatec, we believe access to clean, quality water should be easy,
          reliable, and
          <br className="hidden xl:block" /> stress-free. That's why we created
          a platform that connects you to your favourite
          <br className="hidden xl:block" /> water brands — and brings them
          straight to your door, exactly when you need them.
        </p>
        <p className="text-base xl:text-xl">
          We partner with trusted water suppliers to ensure you always get fresh
          water in the
