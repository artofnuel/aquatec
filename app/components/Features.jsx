        ...
        <section className="mx-auto flex h-auto w-full max-w-7xl flex-col gap-5">
          ...
          <div className="flex h-auto w-full flex-col gap-5">
            {FeaturesData.map((feature, index) =>
              index === 0 ? (
                <MotionSlideRight speed={0.75} key={index}>
                  <div className="group flex h-auto w-full flex-col items-center justify-between xl:h-[630px] xl:flex-row even:xl:flex-row-reverse">
                ...
                <MotionSlideLeft speed={0.75} key={index}>
                  <div
                    className={`group flex h-auto w-full flex-col items-center justify-between xl:h-[630px] xl:flex-row ${index === 1 ? "xl:flex-row-reverse" : ""}`}
                  >
                    <div className="flex h-auto w-full group-even:justify-end xl:h-full xl:w-1/2">
                      <Image
                        src={feature.image}
